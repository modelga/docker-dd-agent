...
# Install the Agent
ADD https://1531-34269086-gh.circle-artifacts.com/0/home/ubuntu/docker-dd-agent-build-deb-x64/pkg/datadog-agent_5.11.0.git.115.c5bc507-1_amd64.deb /
RUN dpkg -i /datadog-agent_5.11.0.git.115.c5bc507-1_amd64.deb && rm /datadog-agent_5.11.0.git.115.c5bc507-1_amd64.deb
